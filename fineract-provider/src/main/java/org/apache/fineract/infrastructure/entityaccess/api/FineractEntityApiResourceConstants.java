...
public class FineractEntityApiResourceConstants {
    ...
    protected static final Set<String> FETCH_ENTITY_TO_ENTITY_MAPPINGS = new HashSet<>(Arrays.asList(mapId,relId,fromEnityType, toEntityType));

    protected static final Set<String> CREATE_ENTITY_MAPPING_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(fromEnityType,
            toEntityType, startDate, LOCALE, DATE_FORMAT, endDate));

    protected static final Set<String> UPDATE_ENTITY_MAPPING_REQUEST_DATA_PARAMETERS = new HashSet<>(Arrays.asList(relId,fromEnityType,
            toEntityType, startDate,LOCALE, DATE_FORMAT, endDate));
